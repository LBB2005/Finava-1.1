    ...
    <div ref={rootRef} className="relative px-[14px] pb-[10px] flex-shrink-0">
      <div className="relative">
        ...
        <input
          ...
          autoComplete="off"
          className="w-full bg-[var(--color-surface)] rounded-[9px] py-[9px] pl-[34px] pr-3 text-[13px] focus:outline-none focus-visible:outline-none transition-colors duration-150"
          style={{
